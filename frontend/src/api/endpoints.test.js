...
const reads = [
  ...
  },
  {
    ...
    expect: ['users/alice/elo-history/'],
    answer: [{ rating: 1200 }],
    result: [{ rating: 1200 }],
  },
  {
  ...
  },
  {
    ...
    expect: ['users/alice/contest-history/', { params: { page_size: 5 } }],
  ...
  },
  {
    ...
    expect: ['users/alice/submissions/', { params: { page_size: 6 } }],
  ...
  },
  {
    ...
    expect: ['users/alice/submissions/', { params: {} }],
    answer: { results: [] },
    result: [],
  },
  {
  ...
  },
  {
    ...
    expect: ['submissions/', { params: { problem: 42 } }],
    answer: { results: [{ id: 5 }] },
    result: [{ id: 5 }],
  },
  {
  ...
  },
  {
    ...
    expect: ['users/standings/', { params: { page: 2 } }],
  ...
  },
  {
    ...
    expect: ['contests/', { params: { status: 'active' } }],
    answer: { results: [{ id: 1 }] },
    result: [{ id: 1 }],
  },
  {
  ...
  },
  {
    ...
    expect: ['contests/7/registrants/', { params: { page: 2 } }],
  ...
  },
  {
    ...
    expect: ['contests/7/leaderboard/', { params: { page: 2 } }],
    answer: { count: 1, results: [] },
    result: { count: 1, results: [] },
  },
];
...
describe.each(reads)('$name', ({ run, expect: expected, answer, result }) => {
