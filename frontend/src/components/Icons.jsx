...
const Icons = {
    ...
    <Ic
      ...
      d={
        <>
          <path d="M6 3h12" />
          <path d="M6 21h12" />
          <path d="M7 3v3.5c0 2 2.2 3.4 3.6 4.7.3.3.4.5.4.8s-.1.5-.4.8C9.2 14.1 7 15.5 7 17.5V21" />
          <path d="M17 3v3.5c0 2-2.2 3.4-3.6 4.7-.3.3-.4.5-.4.8s.1.5.4.8c1.4 1.3 3.6 2.7 3.6 4.7V21" />
        </>
      }
    />
  ),
  ...
  play: (p) => (
    <Ic {...p} fill="currentColor" sw={0} d={<path d="M7 5.5v13l11-6.5z" />} />
  ),
  ...
  flame: (p) => (
    <Ic
      {...p}
      d={
        <path d="M12 3c1 3-1 4-2 6-1 1.7-.4 4 2 4 2.2 0 3-1.6 3-3 1.4 1 2 2.6 2 4a5 5 0 0 1-10 0c0-3 2-4.5 2-7 0-2 1.5-3.2 3-4z" />
      }
    />
  ),
  calendar: (p) => (
  ...
  arrowDown: (p) => (
    <Ic {...p} sw={2.2} d={<path d="M12 5v13M6 12l6 6 6-6" />} />
  ),
  target: (p) => (
    <Ic
      {...p}
  ...
  sparkle: (p) => (
    <Ic
      {...p}
      d={<path d="M12 3l1.8 5.2L19 10l-5.2 1.8L12 17l-1.8-5.2L5 10l5.2-1.8z" />}
    />
  ),
  award: (p) => (
    <Ic
